package com.thiago.animals.detail
...
import com.thiago.animals.home.GenderTag
...
fun DetailScreen(
   ...
   with(sharedTransitionScope) {
       Scaffold(topBar = {
           ...
           val animals = AnimalsDataSource.animalList[index]
...
@Composable
fun AnimalsInfo(animals: Animals) {
    Column {
